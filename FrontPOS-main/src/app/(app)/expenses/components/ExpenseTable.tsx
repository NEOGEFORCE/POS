                  ...
                  <TableCell>
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col min-w-0">
                        ...
                        <span className="text-[8px] text-gray-400 dark:text-zinc-500 font-bold tracking-widest mt-1 uppercase flex items-center gap-2">
                          {expense.category}
                          {expense.status === 'PENDING' && (
                            <span className="animate-pulse flex items-center gap-1 bg-rose-500/10 text-rose-500 px-1.5 py-0.5 rounded text-[7px] font-black tracking-tighter">
                  ...
                  <TableCell className="text-center">
                    <div className="flex flex-col items-center gap-1">
                      <Chip
                        size="sm"
                        variant="flat"
                        className={`text-[9px] font-black h-6 uppercase italic border-none px-2 ${expense.paymentSource === 'NEQUI' ? 'bg-pink-500/10 text-pink-500' :
                      ...
                      {(expense.paymentSource === 'PRESTAMO' || expense.paymentSource === 'PREST.') && expense.lenderName && (
                        <span className="text-[7px] font-black text-amber-500 uppercase italic bg-amber-500/5 px-1.5 py-0.5 rounded-md flex items-center gap-1">
                  ...
                  <TableCell>
                    <div className="flex justify-end items-center gap-4">
                      <div className="flex flex-col items-end leading-none">
                        <span className={`text-[13px] font-black italic tabular-nums tracking-tighter ${expense.status === 'PENDING' ? 'text-amber-500' : 'text-gray-900 dark:text-white'}`}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col items-end leading-tight text-right">
                  ...
                  <div className="flex flex-col items-end mt-1 gap-0.5">
                    <span className={`text-[7px] font-black uppercase tracking-tighter leading-none ${expense.status === 'PENDING' ? 'text-amber-500' : 'text-gray-400'}`}>
