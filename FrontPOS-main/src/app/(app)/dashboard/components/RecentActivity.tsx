...
export default function RecentActivity({ sales }: RecentActivityProps) {
    return (
        <Card className="bg-white/90 dark:bg-zinc-900/50 backdrop-blur-xl border border-gray-200/80 dark:border-white/5 shadow-lg dark:shadow-2xl transition-colors shrink-0" radius="lg">
                            ...
                            <div key={sale.id} className="p-4 flex items-center justify-between">
                                <div className="flex flex-col min-w-0">
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        <Chip size="sm" variant="flat" elevation={0} className={`${chipColor} h-4`} classNames={{ content: "text-[7px] font-black uppercase tracking-widest px-1" }}>
                                            {method}
                                        </Chip>
                                    </div>
                                </div>
