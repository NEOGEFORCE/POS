                    ...
                    <form onSubmit={handleSubmit}>
                        <ModalHeader className="flex flex-col gap-1 px-5 md:px-12 py-3 md:py-4 border-b border-gray-100 dark:border-white/5 bg-[#18181b] dark:bg-[#18181b]/50 rounded-t-2xl md:rounded-t-[2rem]">
                            <h2 className="text-lg md:text-2xl font-medium text-zinc-900 dark:text-zinc-50 tracking-tight tracking-tighter uppercase leading-none flex items-center gap-3 md:gap-4">
                                <div className="h-8 w-8 md:h-14 md:w-14 bg-white/5 text-zinc-900 dark:text-zinc-100 flex items-center justify-center rounded-2xl md:rounded-2xl border border-emerald-500/20"><ShieldCheck size={16} className="md:size-7" /></div>
                                <div className="flex flex-col gap-0.5 md:gap-1">
                                    <span>{!isEdit ? "Cifrar " : "Actualizar "} <span className="text-zinc-900 dark:text-zinc-100">Acceso</span></span>
                                    <span className="text-[7px] md:text-[10px] font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-widest not-tracking-tight opacity-80">Seguro v4.0</span>
                                </div>
                            </h2>
                        </ModalHeader>
                ...
                {(onClose) => (
                    <>
                        ...
                        <ModalFooter className="px-6 md:px-10 py-6 border-t border-gray-100 dark:border-white/5 flex gap-4 rounded-b-[2.5rem] bg-gray-50/50 dark:bg-[#18181b]/50">
                            <Button
                                variant="flat"
                                className="flex-1 h-12 rounded-2xl font-medium text-[10px] tracking-widest bg-gray-100 dark:bg-[#18181b] text-zinc-500 dark:text-zinc-400 uppercase hover:bg-gray-200 dark:hover:bg-zinc-100 dark:bg-zinc-800 tracking-tight transition-all"
                                onPress={onClose}
                            >
                                CANCELAR
                            </Button>
                    ...
                    <form onSubmit={(e) => {
                        ...
                        <ModalBody className="p-6 gap-4 pb-6 sm:pb-6">
                            <div className="space-y-4">
                                <p className="text-[10px] font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-widest leading-relaxed text-center tracking-tight">
