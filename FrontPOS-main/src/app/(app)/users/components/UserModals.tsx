                        ...
                        <ModalHeader className="flex flex-col gap-1 px-5 md:px-12 py-3 md:py-4 border-b border-gray-100 dark:border-white/5 bg-[#18181b] dark:bg-[#18181b]/50 rounded-t-2xl md:rounded-t-[2rem]">
                            <h2 className="text-lg md:text-2xl font-medium text-zinc-900 dark:text-zinc-50 tracking-tight tracking-tighter uppercase leading-none flex items-center gap-3 md:gap-4">
                                ...
                                <div className="flex flex-col gap-0.5 md:gap-1">
                                    <span>{!isEdit ? "Cifrar " : "Actualizar "} <span className="text-zinc-900 dark:text-zinc-100">Acceso</span></span>
                                    <span className="text-[7px] md:text-[10px] font-medium text-gray-500 dark:text-zinc-500 dark:text-zinc-400 uppercase tracking-widest not-tracking-tight opacity-80">Seguro v4.0</span>
                                </div>
                            </h2>
                        </ModalHeader>
                        ...
                        <ModalBody className="px-5 md:px-12 py-3 md:py-6 gap-2 md:gap-4 pb-4 sm:pb-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                                ...
                                <div>
                                    <Input
                                        ...
                                        onFocus={(e) => setTimeout(() => e.target.scrollIntoView({ behavior: 'smooth', block: 'center' }), 300)}
                                        startContent={<Sparkles size={20} className="text-zinc-900 dark:text-zinc-100 mr-3" />}
                            ...
                            <div className="space-y-2">
                                ...
                                <Tabs
                                    ...
                                    fullWidth
                                    classNames={{
                                        tabList: "bg-gray-200/50 dark:bg-zinc-950 border-2 border-gray-400 dark:border-white/10 p-2 rounded-2xl h-14 md:h-20 shadow-inner",
                                        cursor: "bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-white/5 dark:bg-zinc-800 border border-zinc-200 dark:border-white/5 rounded-2xl md:rounded-2xl shadow-[0_0_20px_rgba(16,185,129,0.4)] border-2 border-zinc-200 dark:border-white/10",
                                        tab: "h-full transition-all duration-400",
                                        tabContent: "font-medium text-[10px] md:text-[13px] uppercase tracking-[0.1em] md:tracking-[0.15em] text-gray-400 dark:text-white/30 group-data-[selected=true]:text-black dark:group-data-[selected=true]:!text-white group-data-[selected=true]:scale-115 md:group-data-[selected=true]:scale-120 group-data-[selected=true]:opacity-100 opacity-60 transition-all duration-400 dark:group-data-[selected=true]:drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]"
                                    }}
                                >
                                    <Tab
                                        key="empleado"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                                <div>
                                    <Input
                                        ...
                                        isDisabled={!canFullEdit}
                                        onFocus={(e) => setTimeout(() => e.target.scrollIntoView({ behavior: 'smooth', block: 'center' }), 300)}
                                        startContent={<Mail size={20} className={`transition-colors mr-3 ${['admin', 'administrador', 'superadmin'].includes(localUser?.role || '') ? 'text-zinc-900 dark:text-zinc-100' : 'text-gray-400'}`} />}
                                        classNames={{
                                            label: "absolute z-10 pointer-events-none origin-top-left shrink-0 rtl:origin-top-right subpixel-antialiased block cursor-text will-change-auto !duration-200 !ease-out motion-reduce:transition-none transition-[transform,color,left,opacity,translate,scale] group-data-[filled-within=true]:text-default-600 group-data-[filled-within=true]:pointer-events-auto group-data-[filled-within=true]:scale-85 group-data-[filled-within=true]:-translate-y-[calc(50%_+_var(--heroui-font-size-small)/2_-_6px)] pe-2 max-w-full text-ellipsis overflow-hidden text-[9px] md:text-[10px] font-medium text-gray-500 dark:text-zinc-500 dark:text-zinc-400 uppercase tracking-widest",
                                            inputWrapper: `relative w-full inline-flex tap-highlight-transparent shadow-xs data-[hover=true]:bg-default-200 group-data-[focus=true]:bg-default-100 min-h-10 flex-col items-start justify-center gap-0 motion-reduce:transition-none !duration-150 outline-solid outline-transparent group-data-[focus-visible=true]:z-10 group-data-[focus-visible=true]:ring-2 group-data-[focus-visible=true]:ring-focus group-data-[focus-visible=true]:ring-offset-2 group-data-[focus-visible=true]:ring-offset-background py-2 h-13 md:h-18 md:min-h-[72px] px-4 bg-black/5 dark:bg-[#18181b] border-2 transition-all shadow-inner rounded-2xl ${['admin', 'administrador', 'superadmin'].includes(localUser?.role || '') ? 'border-emerald-500/30' : 'border-transparent'}`,
                                            input: "w-full bg-transparent !outline-solid placeholder:text-foreground-500 focus-visible:outline-solid outline-transparent data-[has-start-content=true]:ps-1.5 data-[has-end-content=true]:pe-1.5 data-[type=color]:rounded-none file:cursor-pointer file:bg-transparent file:border-0 autofill:bg-transparent bg-clip-text dark:autofill:[-webkit-text-fill-color:hsl(var(--heroui-foreground))] [&::-ms-reveal]:hidden group-data-[has-value=true]:text-default-foreground font-medium text-sm md:text-base uppercase tracking-tight text-zinc-900 dark:text-zinc-50"
                                        }}
                                    />
                                </div>
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        onFocus={(e) => setTimeout(() => e.target.scrollIntoView({ behavior: 'smooth', block: 'center' }), 300)}
                                        startContent={<ShieldCheck size={20} className="text-zinc-900 dark:text-zinc-100 mr-3" />}
                                        classNames={{
                                            label: "absolute z-10 pointer-events-none origin-top-left shrink-0 rtl:origin-top-right subpixel-antialiased block cursor-text will-change-auto !duration-200 !ease-out motion-reduce:transition-none transition-[transform,color,left,opacity,translate,scale] group-data-[filled-within=true]:text-default-600 group-data-[filled-within=true]:pointer-events-auto group-data-[filled-within=true]:scale-85 group-data-[filled-within=true]:-translate-y-[calc(50%_+_var(--heroui-font-size-small)/2_-_6px)] pe-2 max-w-full text-ellipsis overflow-hidden text-[9px] md:text-[10px] font-medium text-gray-500 dark:text-zinc-500 dark:text-zinc-400 uppercase tracking-widest",
                                            inputWrapper: "relative w-full inline-flex tap-highlight-transparent shadow-[0_8px_30px_rgb(0,0,0,0.12)] data-[hover=true]:bg-default-200 group-data-[focus=true]:bg-default-100 min-h-10 flex-col items-start justify-center gap-0 motion-reduce:transition-none !duration-150 outline-solid outline-transparent group-data-[focus-visible=true]:z-10 group-data-[focus-visible=true]:ring-2 group-data-[focus-visible=true]:ring-focus group-data-[focus-visible=true]:ring-offset-2 group-data-[focus-visible=true]:ring-offset-background py-2 h-13 md:h-18 md:min-h-[72px] px-4 card-base border-none border-2 transition-all rounded-2xl border-gray-100 dark:border-white/5 focus-within:!border-emerald-500/30",
                                            input: "w-full bg-transparent !outline-solid placeholder:text-foreground-500 focus-visible:outline-solid outline-transparent data-[has-start-content=true]:ps-1.5 data-[has-end-content=true]:pe-1.5 data-[type=color]:rounded-none file:cursor-pointer file:bg-transparent file:border-0 autofill:bg-transparent bg-clip-text dark:autofill:[-webkit-text-fill-color:hsl(var(--heroui-foreground))] [&::-ms-reveal]:hidden group-data-[has-value=true]:text-default-foreground font-medium text-sm md:text-base uppercase tracking-tight text-zinc-900 dark:text-zinc-50"
                                        }}
                                    />
                                </div>
    ...
    return (
        ...
        >
            <ModalContent>
                {(onClose) => (
                    <>
                        <ModalHeader className="flex items-center gap-4 px-6 md:px-10 py-5 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-[#18181b]/50 rounded-t-[2.5rem]">
                        ...
                        <ModalFooter className="px-6 md:px-10 py-6 border-t border-gray-100 dark:border-white/5 flex gap-4 rounded-b-[2.5rem] bg-gray-50/50 dark:bg-[#18181b]/50">
                            <Button
                                variant="flat"
                                className="flex-1 h-12 rounded-2xl font-medium text-[10px] tracking-widest bg-gray-100 dark:bg-[#18181b] text-gray-500 dark:text-zinc-500 dark:text-zinc-400 uppercase hover:bg-gray-200 dark:hover:bg-white/5 dark:bg-transparent tracking-tight transition-all"
                                onPress={onClose}
                            >
                                CANCELAR
                            </Button>
            ...
            <ModalContent>
                {(onClose) => (
                    <form onSubmit={(e) => {
                        ...
                        <ModalHeader className="flex items-center gap-4 px-6 md:px-10 py-4 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-[#18181b]/50 rounded-t-[2.5rem]">
                            ...
                            <div className="flex flex-col">
                                <span className="text-xl font-medium text-zinc-900 dark:text-zinc-50 uppercase tracking-tight tracking-tighter leading-none">Nueva Credencial</span>
                                <span className="text-[10px] font-medium text-amber-500 uppercase tracking-[0.3em] mt-3 not-tracking-tight">Sobreescritura de Seguridad</span>
                            </div>
                        </ModalHeader>
                        <ModalBody className="p-6 gap-4 pb-6 sm:pb-6">
                            <div className="space-y-4">
                                <p className="text-[10px] font-medium text-gray-500 dark:text-zinc-500 dark:text-zinc-400 uppercase tracking-widest leading-relaxed text-center tracking-tight">
                                    Generando nueva clave de acceso para:<br />
                                    <span className="text-zinc-900 dark:text-zinc-50 text-sm">{user?.name} (DNI: {user?.dni})</span>
                                </p>
                                ...
                                <Input
                                    ...
                                    classNames={{
                                        label: "absolute z-10 pointer-events-none origin-top-left shrink-0 rtl:origin-top-right subpixel-antialiased block cursor-text will-change-auto !duration-200 !ease-out motion-reduce:transition-none transition-[transform,color,left,opacity,translate,scale] group-data-[filled-within=true]:text-default-600 group-data-[filled-within=true]:pointer-events-auto group-data-[filled-within=true]:scale-85 group-data-[filled-within=true]:-translate-y-[calc(50%_+_var(--heroui-font-size-small)/2_-_6px)] pe-2 max-w-full text-ellipsis overflow-hidden text-[9px] md:text-[10px] font-medium text-gray-500 dark:text-zinc-500 dark:text-zinc-400 uppercase tracking-widest",
                                        inputWrapper: "relative w-full inline-flex tap-highlight-transparent shadow-xs data-[hover=true]:bg-default-200 group-data-[focus=true]:bg-default-100 min-h-10 flex-col items-start justify-center gap-0 motion-reduce:transition-none !duration-150 outline-solid outline-transparent group-data-[focus-visible=true]:z-10 group-data-[focus-visible=true]:ring-2 group-data-[focus-visible=true]:ring-focus group-data-[focus-visible=true]:ring-offset-2 group-data-[focus-visible=true]:ring-offset-background py-2 h-13 md:h-18 md:min-h-[72px] px-4 bg-gray-50/50 dark:bg-[#18181b]/30 border-2 border-transparent focus-within:!border-amber-500 transition-all shadow-inner rounded-2xl",
                                        input: "w-full bg-transparent !outline-solid placeholder:text-foreground-500 focus-visible:outline-solid outline-transparent data-[has-start-content=true]:ps-1.5 data-[has-end-content=true]:pe-1.5 data-[type=color]:rounded-none file:cursor-pointer file:bg-transparent file:border-0 autofill:bg-transparent bg-clip-text dark:autofill:[-webkit-text-fill-color:hsl(var(--heroui-foreground))] [&::-ms-reveal]:hidden group-data-[has-value=true]:text-default-foreground font-medium text-base text-zinc-900 dark:text-zinc-50 tracking-[0.2em]"
                                    }}
                                />
                            </div>
                        </ModalBody>
                        <ModalFooter className="px-6 md:px-10 py-4 border-t border-gray-100 dark:border-white/5 flex gap-4 rounded-b-[2.5rem] bg-gray-50/50 dark:bg-[#18181b]/50">
                            <Button
                                variant="flat"
                                className="flex-1 h-12 rounded-2xl font-medium text-[10px] tracking-widest bg-gray-100 dark:bg-[#18181b] text-gray-500 dark:text-zinc-500 dark:text-zinc-400 uppercase hover:bg-gray-200 dark:hover:bg-white/5 dark:bg-transparent tracking-tight transition-all"
                            ...
                            <Button
                                ...
                                className="flex-1 h-12 rounded-2xl font-medium text-[10px] tracking-widest shadow-[0_8px_30px_rgb(0,0,0,0.12)] shadow-amber-500/20 uppercase bg-amber-500 text-white tracking-tight hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                ACTUALIZAR CLAVE
                            </Button>
                        </ModalFooter>
