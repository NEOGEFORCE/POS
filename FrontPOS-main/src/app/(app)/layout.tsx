...
export default function AppLayout({
    ...
    return (
        <div className="flex min-h-[100dvh] md:h-screen w-screen overflow-hidden bg-[#09090b]">
            <SidebarProvider defaultOpen={false}>
                <AppSidebar />
                <SidebarInset className="max-w-[100vw] min-w-0 min-h-0 w-full flex-1 md:h-full flex flex-col relative overflow-hidden">

                    <div className="flex flex-col flex-1 min-h-0 w-full md:h-full relative z-0">
