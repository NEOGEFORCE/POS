...
export default function AppLayout({
  ...
  return (
    <SidebarProvider defaultOpen={false}>
      <AppSidebar />
      <SidebarInset className="max-w-[100vw] min-w-0 w-full overflow-hidden">
        {/* Contenedor principal con transición de Claro/Oscuro */}
        <div className="flex flex-col h-[100dvh] bg-gray-50 dark:bg-[#09090b] transition-colors duration-500 overflow-hidden relative min-w-0 w-full max-w-full">
          ...
          <main className="flex-1 p-2 md:p-3 min-w-0 flex flex-col h-full overflow-hidden z-10">
            {children}
          </main>
