          ...
          <form onSubmit={handleSubmit}>
            <ModalHeader className="flex flex-col gap-1 px-5 md:px-12 py-3 md:py-4 border-b border-gray-100 dark:border-white/5 bg-[#18181b] dark:bg-[#18181b]/50 rounded-t-2xl md:rounded-t-[2rem]">
              <h2 className="text-lg md:text-2xl font-medium text-zinc-900 dark:text-zinc-50 tracking-tight tracking-tighter uppercase leading-none flex items-center gap-3 md:gap-4">
                <div className="h-8 w-8 md:h-14 md:w-14 bg-black/5 dark:bg-white/5 text-zinc-900 dark:text-zinc-100 flex items-center justify-center rounded-2xl md:rounded-2xl border border-emerald-500/20">
                ...
                <div className="flex flex-col gap-0.5 md:gap-1">
                  ...
                  <span className="text-[7px] md:text-[10px] font-medium text-gray-500 dark:text-zinc-500 dark:text-zinc-400 uppercase tracking-widest not-tracking-tight opacity-80">Infraestructura de Registros Maestro</span>
                </div>
              </h2>
            </ModalHeader>
