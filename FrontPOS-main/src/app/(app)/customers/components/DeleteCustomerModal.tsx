          ...
          <>
            <ModalHeader className="flex items-center gap-4 p-10 border-b border-gray-100 dark:border-white/5 rounded-t-[2.5rem] bg-gray-50/50 dark:bg-zinc-900/50">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-black text-rose-500 uppercase tracking-[0.3em] mt-3 not-italic">Acción Irreversible</span>
              </div>
            </ModalHeader>
            <ModalBody className="p-10 flex flex-col items-center text-center gap-8">
              ...
              <p className="text-base font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-widest leading-relaxed italic">
                ¿Confirma la eliminación definitiva de este <br/>
                <span className="text-rose-500 font-black">Registro Maestro</span> en la base de datos de clientes?
              </p>
            </ModalBody>
