...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("text-[11px] font-semibold uppercase tracking-wider", className)}
    {...props}
  />
))
