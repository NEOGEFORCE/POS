...
type Expense struct {
	...
	ReturnRef     *uint     `gorm:"index;column:return_ref" json:"returnRef,omitempty"`
	...
	CoinsAmount     float64 `gorm:"type:decimal(10,2);default:0;column:coins_amount" json:"coinsAmount"`
